...
class Library:
    ...
    def display_available_item(self):
        ...
        print("Item List")
        print("--------------", end="\n\n")
        for library_item in self._item_list.get_item_list():
            print(library_item)
...
def generate_test_books():
    ...
    item_list = [
        ...
        Dvd("101.021.054", "Jack In a Sack", 5, "Jeff Stan", "Jan 2023", "NA"),
        Dvd("741.469.420", "Someone is Out There", 5, "Jackie Canon", "Dec 2023", "Asia"),
        Journal("765.565.895", "Sleep and Pain", 9, "Johnny Deep", "1001", "Science Journal"),
        Journal("745.552.854", "Drugs and Pens", 3, "Tiffany Sleep", "1002", "Science Journal")
    ]
    return item_list
