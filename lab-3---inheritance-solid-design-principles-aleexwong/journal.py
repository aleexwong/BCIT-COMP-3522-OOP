class Journal:
    """
    this class is for journal articles in a library, found with its issue number
    """
    ...
    def increment_number_of_copies(self):
        """
            Set's the number of copies of an journal
    ...
    def check_availability(self):
        """
            Returns True if the journal is available and False otherwise
            :return: A Boolean
            """
